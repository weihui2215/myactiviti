...
<head>
	...
	<link rel="stylesheet" href="${request.contextPath}/js/common/plugins/timepicker.css">
	<title>请假申请</title>
	<script type="text/javascript" src="${request.contextPath}/js/common/jquery.js"></script>
	<script type="text/javascript" src="${request.contextPath}/js/common/bootstrap.min.js"></script>
	<script type="text/javascript" src="${request.contextPath}/js/common/bootstrap-datepicker.js"></script>
	<script type="text/javascript" src="${request.contextPath}/js/common/plugins/bootstrap-timepicker.js"></script>
...
<body>
	...
	<form action="${request.contextPath}/leave/start" class="form-horizontal" method="post" onsubmit="beforeSend()">
