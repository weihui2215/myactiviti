...
<head>
    ...
    <script src="${request.contextPath}/js/common/bootstrap.min.js" type="text/javascript"></script>
    <script src="${request.contextPath}/js/modules/main/main.js" type="text/javascript"></script>
